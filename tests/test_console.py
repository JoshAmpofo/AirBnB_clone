...
class TestHBNBCommand_prompting(unittest.TestCase):
    """unittests for testing prompting in command interpreter"""
...
class TestHBNBCommand_help(unittest.TestCase):
    """unittests for help messages of command interpreter"""
    ...
    def test_help_EOF(self):
        h = "CTRL+D function to abruptly but cleanly terminate program"
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("help EOF"))
            self.assertEqual(h, output.getvalue().strip())

    def test_help_create(self):
        h = ("Usage: <create classname>\n        "
    ...
    def test_help_destroy(self):
        h = ("Delete an instance based on the className and Id,\n        "
